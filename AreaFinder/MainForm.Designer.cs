...
namespace AreaFinder
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbRGBThreshold.ValueChanged += new System.EventHandler(this.tbThreshold_ValueChanged);
			// 
			...
			this.Controls.Add(this.tbHSBThresholdDisplay);
			this.Controls.Add(this.tbHSBThreshold);
			this.Controls.Add(this.label4);
			this.Controls.Add(this.label3);
			this.Controls.Add(this.label2);
			this.Controls.Add(this.label1);
			this.Controls.Add(this.tbRGBThresholdDisplay);
			this.Controls.Add(this.tbRGBThreshold);
